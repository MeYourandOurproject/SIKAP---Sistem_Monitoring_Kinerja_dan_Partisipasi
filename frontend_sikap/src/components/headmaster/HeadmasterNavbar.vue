<template>
  <!-- Desktop Navbar Only -->
  <nav class="navbar headmaster-navbar sticky-top shadow-sm d-none d-md-block">
    <div class="container-fluid px-1 px-md-3">
      <div class="align-items-center gap-3 w-100 p-md-2 p-0 d-flex">
        ...
        <div class="navbar-breadcrumb d-flex flex-column text-white text-start">
          <span class="text-opacity text-success">Dashboard</span>
          <strong class="navbar-title text-secondary"
            >Dashboard / {{ menuTitle }}</strong
          >
        </div>
