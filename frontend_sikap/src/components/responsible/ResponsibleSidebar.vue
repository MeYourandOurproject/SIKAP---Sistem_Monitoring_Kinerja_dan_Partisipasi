    ...
    <aside class="sidebar">
      ...
      <nav class="sidebar-nav px-2 py-3">
        <ul class="nav flex-column text-white">
          <li class="nav-item">
            <router-link
              to="/penanggung-jawab/dashboard"
              class="nav-link"
              :class="{ active: isActive('/penanggung-jawab/dashboard') }"
              @click="closeSidebar"
            >
          ...
          <li class="nav-item">
            <router-link
              ...
              class="nav-link"
              :class="{ active: isActive('/penanggung-jawab/kegiatan') }"
              @click="closeSidebar"
            >
          ...
          <li class="nav-item">
            <router-link
              ...
              class="nav-link"
              :class="{ active: isActive('/penanggung-jawab/absensi') }"
              @click="closeSidebar"
            >
          ...
          <li class="nav-item">
            <router-link
              to="/penanggung-jawab/settings"
              class="nav-link"
              :class="{ active: isActive('/penanggung-jawab/settings') }"
              @click="closeSidebar"
...
.sidebar {
  ...
  color: #e7f5e7;
  border-right: 3px solid rgba(166, 255, 175, 0.12);
  overflow-y: auto;
  display: flex;
