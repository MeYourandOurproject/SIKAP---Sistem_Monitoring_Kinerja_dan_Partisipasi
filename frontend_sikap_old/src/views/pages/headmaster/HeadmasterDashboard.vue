              ...
              <div class="col-8">
                <p class="text-1 mb-2 text-success fw-bold">
                  ...
                  <br /><span class="text-muted text-3"
                    ...
                    Senin, 15 Januari 2026 | 09.10.19
                  </span>
                </p>
              </div>
            </div>
        ...
        <div class="card stat-card shadow-sm">
          <div class="card-body gap-0 px-3">
            ...
            <div class="stat-value text-start">
              <div class="status-main">70 Guru</div>
              <div class="status-sub text-success">
                PNS (56) | P3K (14) | P3K PW & Honorer (16)
              </div>
            </div>
          </div>
        </div>
...
export default {
  ...
  data() {
    return {
      rating: (80 / 100) * 5,
      headmasterName: "Yudi Karwati, S.Pd., M.T.",
      journals: [
        {
          date: "22 Apr 2024",
          title: "Membuat laporan testing sistem",
          status: "Disetujui",
        },
        {
          date: "21 Apr 2024",
          title: "Meeting tim pengembangan",
          status: "Disetujui",
        },
        {
          date: "20 Apr 2024",
          title: "Memperbaiki bug pada modul user",
          status: "Disetujui",
        },
        {
          date: "19 Apr 2024",
          title: "Mendesain antarmuka aplikasi",
          status: "Disetujui",
        },
        {
          date: "18 Apr 2024",
          title: "Belajar framework Vue.js",
          status: "Disetujui",
        },
      ],
    };
  ...
  mounted() {
    this.loadheadmasterData();
  },
  methods: {
    loadheadmasterData() {
      try {
        const user = JSON.parse(localStorage.getItem("user") || "{}");
        this.headmasterName = user.name || "Yudi Karwati, S.Pd., M.T.";
      } catch (error) {
        console.error("Error loading headmaster data:", error);
      }
    },
    formatDate(date) {
      if (!date) return "-";
